...
const mockMomos = [
  {
    ...
    price: 320,
    flavor: "classic",
    image: "https://images.unsplash.com/photo-1626700055272-8e4c0e9b7a5e?w=800",
    isVeg: false,
    rating: 4.8,
  },
  {
  ...
  },
  {
    ...
    price: 280,
    flavor: "veggie",
    image: "https://images.unsplash.com/photo-1626645738538-2c4f7e0b0e2d?w=800",
    isVeg: true,
    rating: 4.6,
  },
  {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {products.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-500">Try changing filters or search term</p>
          </div>
        ) : (
